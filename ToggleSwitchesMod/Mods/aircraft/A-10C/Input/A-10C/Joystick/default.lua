...
{down = iCommandViewFastKeyboard, name = 'Camera view keyboard rate fast', category = 'View'},
{down = iCommandViewSlowKeyboard, name = 'Camera view keyboard rate slow', category = 'View'},
{down = iCommandViewNormalKeyboard, name = 'Camera view keyboard rate normal', category = 'View'},
{down = iCommandViewFastMouse, name = 'Camera view mouse rate fast', category = 'View'},
{down = iCommandViewSlowMouse, name = 'Camera view mouse rate slow', category = 'View'},
{down = iCommandViewNormalMouse, name = 'Camera view mouse rate normal', category = 'View'},
...
{down = iCommandViewTransposeModeOn, up = iCommandViewTransposeModeOff, name = 'Camera transpose mode (press and hold)', category = 'View Cockpit'},
...
{down = iCommandElectricalPowerInverterTEST                     , name = 'Inverter TEST', category = 'Electrical power control panel'},
...
{down = iCommandAPUGeneratorPower, up = iCommandAPUGeneratorPower								, name = 'APU generator switch', category = 'Electrical power control panel'},
{down = iCommandElectricalPowerInverterSTBY, up = iCommandElectricalPowerInverterOFF					, name = 'Inverter switch', category = 'Electrical power control panel'},
{down = iCommandElectricalPowerInverterOFF						, name = 'Inverter OFF', category = 'Electrical power control panel'},
{down = iCommandElectricalPowerInverterTEST, up = iCommandElectricalPowerInverterOFF, name = 'Inverter TEST switch', category = 'Electrical power control panel'},
{down = iCommandEmergencyFlood, up = iCommandEmergencyFlood						, name = 'Emergency flood switch', category = 'Electrical power control panel'},
{down = iCommandPowerGeneratorLeft, up = iCommandPowerGeneratorLeft								, name = 'AC generator power left switch', category = 'Electrical power control panel'},
{down = iCommandPowerGeneratorRight, up = iCommandPowerGeneratorRight							, name = 'AC generator power right switch', category = 'Electrical power control panel'},
{down = iCommandBatteryPower, up = iCommandBatteryPower									, name = 'Battery power switch', category = 'Electrical power control panel'},
...
{down = iCommandPlaneFSTankCrossFeed, up = iCommandPlaneFSTankCrossFeed							, name = 'Fuel crossfeed valve switch', category = 'Fuel system control panel'},

{down = iCommandPlaneFSLeftWingBoostPump						, name = 'Left wing tank boost pump', category = 'Fuel system control panel'},
{down = iCommandPlaneFSLeftWingBoostPump, up = iCommandPlaneFSLeftWingBoostPump						, name = 'Left wing tank boost pump switch', category = 'Fuel system control panel'},

{down = iCommandPlaneFSRightWingBoostPump						, name = 'Right wing tank boost pump', category = 'Fuel system control panel'},
{down = iCommandPlaneFSRightWingBoostPump, up = iCommandPlaneFSRightWingBoostPump						, name = 'Right wing tank boost pump switch', category = 'Fuel system control panel'},
...
{down = iCommandPlaneFSLeftMainBoostPump, up = iCommandPlaneFSLeftMainBoostPump						, name = 'Left main tank boost pump switch', category = 'Fuel system control panel'},

{down = iCommandPlaneFSRightMainBoostPump						, name = 'Right main tank boost pump', category = 'Fuel system control panel'},
{down = iCommandPlaneFSRightMainBoostPump, up = iCommandPlaneFSRightMainBoostPump						, name = 'Right main tank boost pump switch', category = 'Fuel system control panel'},
...
{down = iCommandPlaneYawSASEngageL, up = iCommandPlaneYawSASEngageL							, name = 'Yaw SAS engage Left Switch', category = 'Stability Augmentation System'},

{down = iCommandPlaneYawSASEngageR							, name = 'Yaw SAS engage Right', category = 'Stability Augmentation System'},
{down = iCommandPlaneYawSASEngageR, up = iCommandPlaneYawSASEngageR							, name = 'Yaw SAS engage Right Switch', category = 'Stability Augmentation System'},

{down = iCommandPlanePitchSASEngageL						, name = 'Pitch SAS engage Left', category = 'Stability Augmentation System'},
{down = iCommandPlanePitchSASEngageL, up = iCommandPlanePitchSASEngageL						, name = 'Pitch SAS engage Left Switch', category = 'Stability Augmentation System'},

{down = iCommandPlanePitchSASEngageR						, name = 'Pitch SAS engage Right', category = 'Stability Augmentation System'},
{down = iCommandPlanePitchSASEngageR, up = iCommandPlanePitchSASEngageR						, name = 'Pitch SAS engage Right Switch', category = 'Stability Augmentation System'},
...
{down = iCommandPlanePositionLightsFlash, up =  iCommandPlanePositionLightsOff,				name = 'alt Position Lights Flash', category = 'Lighting Panel'},
...
{down = iCommandPlanePositionLightsSteady, up =  iCommandPlanePositionLightsOff,	name = 'alt Position Lights Steady', category = 'Lighting Panel'},
...
{down = 3010, up = 3011, cockpit_device_id = 49, value_down = 1.0,	value_up = -1.0, name = 'Anti-Collision Lights switch', category = 'Lighting Panel'},
...
{down = iCommandPlaneAHCPMasterArm, up = iCommandPlaneAHCPMasterSafe,									name = 'Master switch ARM switch', category = 'Armament HUD Control Panel'},
...
{down = iCommandPlaneAHCPMasterTrain, up = iCommandPlaneAHCPMasterSafe,									name = 'Master switch TRAIN switch', category = 'Armament HUD Control Panel'},

{down = iCommandPlaneAHCPGUNPACArm, 									name = 'GUN/PAC switch ARM', category = 'Armament HUD Control Panel'},
{down = iCommandPlaneAHCPGUNPACArm, up = iCommandPlaneAHCPGUNSafe,									name = 'GUN/PAC switch ARM switch', category = 'Armament HUD Control Panel'},
...
{down = iCommandPlaneAHCPGUNArm, up = iCommandPlaneAHCPGUNSafe,										name = 'GUN/PAC switch GUNARM switch', category = 'Armament HUD Control Panel'},

{down = iCommandPlaneAHCPLaserArm, 										name = 'LASER switch ARM', category = 'Armament HUD Control Panel'},
{down = iCommandPlaneAHCPLaserArm, 	up = iCommandPlaneAHCPLaserSafe,									name = 'LASER switch ARM switch', category = 'Armament HUD Control Panel'},
...
{down = iCommandPlaneAHCPTGPOnOff, 	up = iCommandPlaneAHCPTGPOnOff,									name = 'TGP switch ON/OFF switch', category = 'Armament HUD Control Panel'},

{down = iCommandPlaneAHCPAltSCEBaro, 									name = 'ALT SCE switch BARO', category = 'Armament HUD Control Panel'},
{down = iCommandPlaneAHCPAltSCEBaro, up = iCommandPlaneAHCPAltSCEDelta,									name = 'ALT SCE switch BARO switch', category = 'Armament HUD Control Panel'},
...
{down = iCommandPlaneAHCPAltSCERadar, up = iCommandPlaneAHCPAltSCEDelta,									name = 'ALT SCE switch RADAR switch', category = 'Armament HUD Control Panel'},

{down = iCommandPlaneAHCPHUDModeDayNight, 								name = 'HUD Mode switch Day/Night', category = 'Armament HUD Control Panel'},
{down = iCommandPlaneAHCPHUDModeDayNight, up = iCommandPlaneAHCPHUDModeDayNight,								name = 'HUD Mode switch Day/Night switch', category = 'Armament HUD Control Panel'},

{down = iCommandPlaneAHCPHUDModeNormSTBY, 								name = 'HUD Mode switch NORM/STBY', category = 'Armament HUD Control Panel'},
{down = iCommandPlaneAHCPHUDModeNormSTBY, up = iCommandPlaneAHCPHUDModeNormSTBY,								name = 'HUD Mode switch NORM/STBY switch', category = 'Armament HUD Control Panel'},

{down = iCommandPlaneAHCPCICUOnOff, 									name = 'CICU switch ON/OFF', category = 'Armament HUD Control Panel'},
{down = iCommandPlaneAHCPCICUOnOff, up = iCommandPlaneAHCPCICUOnOff,									name = 'CICU switch ON/OFF switch', category = 'Armament HUD Control Panel'},

{down = iCommandPlaneAHCPJTRSOnOff, 									name = 'JTRS switch ON/OFF', category = 'Armament HUD Control Panel'},
{down = iCommandPlaneAHCPJTRSOnOff, up = iCommandPlaneAHCPJTRSOnOff,									name = 'JTRS switch ON/OFF switch', category = 'Armament HUD Control Panel'},

{down = iCommandPlaneAHCPIFFCCOn, 										name = 'IFFCC switch ON', category = 'Armament HUD Control Panel'},
{down = iCommandPlaneAHCPIFFCCOn, 	up = iCommandPlaneAHCPIFFCCTest,									name = 'IFFCC switch ON switch', category = 'Armament HUD Control Panel'},
...
{down = iCommandPlaneAHCPIFFCCOff, up = iCommandPlaneAHCPIFFCCTest,										name = 'IFFCC switch OFF switch', category = 'Armament HUD Control Panel'},
...
{down = iCommandPlaneGearUp, up = iCommandPlaneGearDown, 		name = 'Landing Gear Switch', category = 'Landing gear panel'},
...
{down = iCommandPlaneLGPAntiSkid, up = iCommandPlaneLGPAntiSkid,							name = 'Anti-Skid switch', category = 'Landing gear panel'},
...
{down = iCommandPlaneLGPLandLight, up = iCommandPlaneLGPLightsOff,								name = 'Landing Lights On switch', category = 'Landing gear panel'},
...
{down = iCommandPlaneLGPTaxiLight, up = iCommandPlaneLGPLightsOff,								name = 'Taxi Lights On switch', category = 'Landing gear panel'},
...
{down = iCommandPlane_AAP_CDU_Power, up = iCommandPlane_AAP_CDU_Power,					name = 'AAP CDU Power Switch 10', category = 'AAP'},

{down = iCommandPlane_AAP_EGI_Power,				name = 'AAP EGI Power Switch', category = 'AAP'},
{down = iCommandPlane_AAP_EGI_Power, up = iCommandPlane_AAP_EGI_Power,				name = 'AAP EGI Power Switch10', category = 'AAP'},
...
{down = iCommandPlane_AAP_PageSel_STEER, up = iCommandPlane_AAP_PageSel_WAYPT, 				name = 'AAP Page Select STEER10', category = 'AAP'},
...
{down = iCommandPlane_AAP_SteerPt_FLTPLAN, up = iCommandPlane_AAP_SteerPt_MARK, 				name = 'AAP Steer Point FLT PLAN10', category = 'AAP'},
...
{down = iCommandPlane_AAP_SteerPt_MISSION, up = iCommandPlane_AAP_SteerPt_MARK, 				name = 'AAP Steer Point MISSION10', category = 'AAP'},
...
{down = iCommandPlane_TACAN_Mode_TR, up = iCommandPlane_TACAN_Mode_Off,					name = 'TACAN Mode Select T R 10', category = 'TACAN Control Panel'},
...
--- Kneeboard
{down = 3001, cockpit_device_id  = 100, value_down = 1.0, name = 'Kneeboard Next Page'  , category = 'Kneeboard'},
{down = 3002, cockpit_device_id  = 100, value_down = 1.0, name = 'Kneeboard Previous Page', category = 'Kneeboard'},
{down = iCommandPlaneShowKneeboard,	name = 'Kneeboard ON/OFF', category = 'Kneeboard'},
{down = iCommandPlaneShowKneeboard, up = iCommandPlaneShowKneeboard ,value_down = 1.0,value_up = -1.0, name = 'Kneeboard glance view'  , category = 'Kneeboard'},
{down = 3003	, cockpit_device_id  = 100,value_down = 1.0, name = 'Kneeboard current position mark point'  , category = 'Kneeboard'},
