...
{combos = {{key = "JOY_BTN2"}, }, pressed = iCommandPlaneDesignate_CageOn, up = iCommandPlaneDesignate_CageOff,  name = _("Uncage SHKVAL, designate target"),  category = _("Ins Cyclic Stick"), },
{combos = {{key = "JOY_BTN8"}, }, pressed = iCommandPlaneRadarRight, up = iCommandPlaneRadarStop,  name = _("KU-31 Shkval slew right"),  category = _("Ins Cyclic Stick"), },
...
{combos = {{key = "JOY_BTN12"}, }, down = iCommandHelicopter_PanelsIlluminationButtonDown, up = iCommandHelicopter_PanelsIlluminationButtonUp,  name = _("Cockpit gauges illumination (stick)"),  category = _("Ins Cyclic Stick"), },
...
{combos = {{key = "JOY_BTN5"}, }, down = iCommandPlaneModeCannon,  name = _("Gun Select"),  category = _("Ins Cyclic Stick"), },
...
{combos = {{key = "JOY_BTN9"}, }, pressed = iCommandPlaneRadarDown, up = iCommandPlaneRadarStop,  name = _("KU-31 Shkval slew down"),  category = _("Ins Cyclic Stick"), },
...
{combos = {{key = "JOY_BTN14"}, }, down = iCommandPlane_SPU9_PTT_on, up = iCommandPlane_SPU9_PTT_off,  name = _("SPU-9 PTT"),  category = _("Ins Cyclic Stick"), },
...
{combos = {{key = "JOY_BTN10"}, }, pressed = iCommandPlaneRadarLeft, up = iCommandPlaneRadarStop,  name = _("KU-31 Shkval slew left"),  category = _("Ins Cyclic Stick"), },
...
{combos = {{key = "JOY_BTN11"}, }, down = iCommandPlaneRadarCenter,  name = _("KU-31 Shkval center"),  category = _("Ins Cyclic Stick"), },
...
{combos = {{key = "JOY_BTN6"}, }, down = iCommandPlanePickleOn, up = iCommandPlanePickleOff,  name = _("Release weapons"),  category = _("Ins Cyclic Stick"), },
...
{combos = {{key = "JOY_BTN13"}, }, down = iCommandAutopilotEmergOFF, up = iCommandAutopilotEmergOFF_up,  name = _("Autopilot Emergency Off"),  category = _("Ins Cyclic Stick"), },
...
{combos = {{key = "JOY_BTN7"}, }, pressed = iCommandPlaneRadarUp, up = iCommandPlaneRadarStop,  name = _("KU-31 Shkval slew up"),  category = _("Ins Cyclic Stick"), },
