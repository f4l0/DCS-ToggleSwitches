...
{down = device_commands.Button_3, up = device_commands.Button_3, cockpit_device_id  = devices.K14_GUNSIGHT, value_down = 0.0, value_up = 0.1, name = 'AlternTE Gunsight mode FIXED', category = 'K-14 gunsight'},
