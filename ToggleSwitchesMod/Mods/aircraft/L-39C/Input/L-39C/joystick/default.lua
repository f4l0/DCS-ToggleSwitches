...
{pressed = device_commands.Button_3,	cockpit_device_id = devices.FAILURES_PANEL,	value_pressed = 0.5,	name = _('Static Pressure Failure Knob - CW'),	category = _('Systems')},
{pressed = device_commands.Button_3,	cockpit_device_id = devices.FAILURES_PANEL,	value_pressed = -0.5,	name = _('Static Pressure Failure Knob - CCW'),	category = _('Systems')},
{pressed = device_commands.Button_4,	cockpit_device_id = devices.FAILURES_PANEL,	value_pressed = 0.5,	name = _('Full Pressure Failure Knob - CW'),	category = _('Systems')},
{pressed = device_commands.Button_4,	cockpit_device_id = devices.FAILURES_PANEL,	value_pressed = -0.5,	name = _('Full Pressure Failure Knob - CCW'),	category = _('Systems')},
...
{down = iCommand_FireExting_TestGroups, up = iCommand_FireExting_TestGroups,	value_down = 1.0,	value_up = 0.0,	name = _('Fire Signals Test Switch, I'),	category = _('Engine Control Panel')},
{down = iCommand_FireExting_TestGroups, up = iCommand_FireExting_TestGroups,	value_down = -1.0,	value_up = 0.0,	name = _('Fire Signals Test Switch, II'),	category = _('Engine Control Panel')},
-- vibration
...
-- RT-12
{down = engine_commands.CMD_RT_12_OFF_CVR_EXT,	cockpit_device_id = devices.ENGINE_INTERFACE,	value_down = -1.0,	name = _('RT-12 JPT Regulator Manual Disable Switch Cover - OPEN/CLOSE'),	category = _('Engine Control Panel')},
{down = engine_commands.CMD_RT_12_OFF_CVR_EXT,	cockpit_device_id = devices.ENGINE_INTERFACE,	value_down = 1.0,	name = _('RT-12 JPT Regulator Manual Disable Switch Cover - OPEN'),			category = _('Engine Control Panel')},
{down = engine_commands.CMD_RT_12_OFF_CVR_EXT,	cockpit_device_id = devices.ENGINE_INTERFACE,	value_down = 0.0,	name = _('RT-12 JPT Regulator Manual Disable Switch Cover - CLOSE'),		category = _('Engine Control Panel')},
{down = engine_commands.CMD_RT_12_OFF_EXT,		cockpit_device_id = devices.ENGINE_INTERFACE,	value_down = -1.0,	name = _('RT-12 JPT Regulator Manual Disable Switch - DISABLED/ENABLED'),	category = _('Engine Control Panel')},
{down = engine_commands.CMD_RT_12_OFF_EXT,		cockpit_device_id = devices.ENGINE_INTERFACE,	value_down = 1.0,	name = _('RT-12 JPT Regulator Manual Disable Switch - DISABLED'),			category = _('Engine Control Panel')},
{down = engine_commands.CMD_RT_12_OFF_EXT,		cockpit_device_id = devices.ENGINE_INTERFACE,	value_down = 0.0,	name = _('RT-12 JPT Regulator Manual Disable Switch - ENABLED'),			category = _('Engine Control Panel')},
...
{down = iCommandEngineLaunchMethod,	value_down = 0.0,	name = _('Engine Launch Method Switch - STARTING'),	category = _('Engine Control Panel')},
...
------------------------------------------------
{down = electric_commands.L39C_Command_BatterySw_EXT,			cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('Battery Switch - ON/OFF'),					category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_BatterySw_EXT,			cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1.0,	name = _('Battery Switch - ON'),						category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_BatterySw_EXT,			cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 0.0,	name = _('Battery Switch - OFF'),						category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_MainGeneratorSw_EXT,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('Main Generator Switch - ON/OFF'),				category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_MainGeneratorSw_EXT,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1.0,	name = _('Main Generator Switch - ON'),					category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_MainGeneratorSw_EXT,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 0.0,	name = _('Main Generator Switch - OFF'),				category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_EmergGeneratorSw_EXT,	cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('Emergency Generator Switch - ON/OFF'),		category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_EmergGeneratorSw_EXT,	cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1.0,	name = _('Emergency Generator Switch - ON'),			category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_EmergGeneratorSw_EXT,	cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 0.0,	name = _('Emergency Generator Switch - OFF'),			category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_Engine_EXT,			cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('CB Engine Switch - ON/OFF'),					category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_Engine_EXT,			cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1.0,	name = _('CB Engine Switch - ON'),						category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_Engine_EXT,			cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 0.0,	name = _('CB Engine Switch - OFF'),						category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_AGD_GMK_EXT,			cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('CB AGD-GMK Switch - ON/OFF'),					category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_AGD_GMK_EXT,			cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1.0,	name = _('CB AGD-GMK Switch - ON'),						category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_AGD_GMK_EXT,			cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 0.0,	name = _('CB AGD-GMK Switch - OFF'),					category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_Converter1Sw_EXT,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('CB Inverter 1 (AC 115 V) Switch - ON/OFF'),	category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_Converter1Sw_EXT,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1.0,	name = _('CB Inverter 1 (AC 115 V) Switch - ON'),		category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_Converter1Sw_EXT,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 0.0,	name = _('CB Inverter 1 (AC 115 V) Switch - OFF'),		category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_Converter2Sw_EXT,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('CB Inverter 2 (AC 115 V) Switch - ON/OFF'),	category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_Converter2Sw_EXT,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1.0,	name = _('CB Inverter 2 (AC 115 V) Switch - ON'),		category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_Converter2Sw_EXT,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 0.0,	name = _('CB Inverter 2 (AC 115 V) Switch - OFF'),		category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_RTL_EXT,				cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('CB RDO (ICS and Radio) Switch - ON/OFF'),		category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_RTL_EXT,				cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1.0,	name = _('CB RDO (ICS and Radio) Switch - ON'),			category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_RTL_EXT,				cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 0.0,	name = _('CB RDO (ICS and Radio) Switch - OFF'),		category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_MRP_RV_EXT,			cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('CB MRP-RV (Marker Beacon Receiver and Radio Altimeter) Switch - ON/OFF'),	category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_MRP_RV_EXT,			cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1.0,	name = _('CB MRP-RV (Marker Beacon Receiver and Radio Altimeter) Switch - ON'),		category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_MRP_RV_EXT,			cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 0.0,	name = _('CB MRP-RV (Marker Beacon Receiver and Radio Altimeter) Switch - OFF'),	category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_ISKRA_EXT,			cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('CB RSBN (ISKRA) Switch - ON/OFF'),						category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_ISKRA_EXT,			cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1.0,	name = _('CB RSBN (ISKRA) Switch - ON'),							category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_ISKRA_EXT,			cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 0.0,	name = _('CB RSBN (ISKRA) Switch - OFF'),							category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_EMERG_SRO_EXT,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('CB IFF (SRO) Emergency Connection Switch - ON/OFF'),		category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_EMERG_SRO_EXT,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1.0,	name = _('CB IFF (SRO) Emergency Connection Switch - ON'),			category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_EMERG_SRO_EXT,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 0.0,	name = _('CB IFF (SRO) Emergency Connection Switch - OFF'),			category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_EMERG_ISKRA_EXT,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('CB RSBN (ISKRA) Emergency Connection Switch - ON/OFF'),	category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_EMERG_ISKRA_EXT,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1.0,	name = _('CB RSBN (ISKRA) Emergency Connection Switch - ON'),		category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_EMERG_ISKRA_EXT,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 0.0,	name = _('CB RSBN (ISKRA) Emergency Connection Switch - OFF'),		category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_WingTanks_EXT,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('CB Wing Tanks Switch - ON/OFF'),				category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_WingTanks_EXT,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1.0,	name = _('CB Wing Tanks Switch - ON'),					category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_WingTanks_EXT,		cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 0.0,	name = _('CB Wing Tanks Switch - OFF'),					category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_RIO_EXT,				cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('CB RIO-3 De-Icing Signal Switch - ON/OFF'),	category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_RIO_EXT,				cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1.0,	name = _('CB RIO-3 De-Icing Signal Switch - ON'),		category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_RIO_EXT,				cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 0.0,	name = _('CB RIO-3 De-Icing Signal Switch - OFF'),		category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_SDU_EXT,				cockpit_device_id = devices.ELEC_INTERFACE,	value_down = -1.0,	name = _('CB SDU Switch - ON/OFF'),						category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_SDU_EXT,				cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 1.0,	name = _('CB SDU Switch - ON'),							category = _('Main CB Switch Panel')},
{down = electric_commands.L39C_Command_CB_SDU_EXT,				cockpit_device_id = devices.ELEC_INTERFACE,	value_down = 0.0,	name = _('CB SDU Switch - OFF'),						category = _('Main CB Switch Panel')},
...
{down = device_commands.Button_18,		cockpit_device_id = devices.RSBN_5,	value_down = 1.0,		name = _('RSBN-5 Navigation Channel - INCREASE'),	category = _('RSBN-5 Control Panel')},
{down = device_commands.Button_18,		cockpit_device_id = devices.RSBN_5,	value_down = -1.0,		name = _('RSBN-5 Navigation Channel - DECREASE'),	category = _('RSBN-5 Control Panel')},
{down = device_commands.Button_19,		cockpit_device_id = devices.RSBN_5,	value_down = 1.0,		name = _('RSBN-5 Landing Channel - INCREASE'),		category = _('RSBN-5 Control Panel')},
{down = device_commands.Button_19,		cockpit_device_id = devices.RSBN_5,	value_down = -1.0,		name = _('RSBN-5 Landing Channel - DECREASE'),		category = _('RSBN-5 Control Panel')},
{pressed = device_commands.Button_20,	cockpit_device_id = devices.RSBN_5,	value_pressed = 0.5,	name = _('RSBN-5 Volume Rheostat - CW'),			category = _('RSBN-5 Control Panel')},
{pressed = device_commands.Button_20,	cockpit_device_id = devices.RSBN_5,	value_pressed = -0.5,	name = _('RSBN-5 Volume Rheostat - CCW'),			category = _('RSBN-5 Control Panel')},
{down = device_commands.Button_21,	up = device_commands.Button_21,	cockpit_device_id = devices.RSBN_5,	value_down = 1.0,	value_up = 0.0,	name = _('RSBN-5 Azimuth 0 Setting Button'),	category = _('RSBN-5 Control Panel')},
{down = device_commands.Button_22,	up = device_commands.Button_22,	cockpit_device_id = devices.RSBN_5,	value_down = 1.0,	value_up = 0.0,	name = _('RSBN-5 Azimuth Initial Setting Switch - INCREASE'),	category = _('RSBN-5 Control Panel')},
{down = device_commands.Button_22,	up = device_commands.Button_22,	cockpit_device_id = devices.RSBN_5,	value_down = -1.0,	value_up = 0.0,	name = _('RSBN-5 Azimuth Initial Setting Switch - DECREASE'),	category = _('RSBN-5 Control Panel')},
{down = device_commands.Button_23,	up = device_commands.Button_23,	cockpit_device_id = devices.RSBN_5,	value_down = 1.0,	value_up = 0.0,	name = _('RSBN-5 Distance Initial Setting Switch - INCREASE'),	category = _('RSBN-5 Control Panel')},
{down = device_commands.Button_23,	up = device_commands.Button_23,	cockpit_device_id = devices.RSBN_5,	value_down = -1.0,	value_up = 0.0,	name = _('RSBN-5 Distance Initial Setting Switch - DECREASE'),	category = _('RSBN-5 Control Panel')},
{down = device_commands.Button_24,	up = device_commands.Button_24,	cockpit_device_id = devices.RSBN_5,	value_down = 1.0,	value_up = 0.0,	name = _('RSBN-5 Listen Callsign Button'),						category = _('RSBN-5 Control Panel')},
{pressed = device_commands.Button_25,	cockpit_device_id = devices.RSBN_5,	value_pressed = 0.3,	name = _('RSBN-5 QNH Pressure Knob - CW'),			category = _('RSBN-5 Control Panel')},
{pressed = device_commands.Button_25,	cockpit_device_id = devices.RSBN_5,	value_pressed = -0.3,	name = _('RSBN-5 QNH Pressure Knob - CCW'),			category = _('RSBN-5 Control Panel')},
{down = device_commands.Button_26,		cockpit_device_id = devices.RSBN_5,	value_down = -1,		name = _('RSBN-5 Emergency Landing Mode On Switch - ON/OFF'),	category = _('RSBN-5 Control Panel')},
{down = device_commands.Button_26,		cockpit_device_id = devices.RSBN_5,	value_down = 1,			name = _('RSBN-5 Emergency Landing Mode On Switch - ON'),		category = _('RSBN-5 Control Panel')},
{down = device_commands.Button_26,		cockpit_device_id = devices.RSBN_5,	value_down = 0,			name = _('RSBN-5 Emergency Landing Mode On Switch - OFF'),		category = _('RSBN-5 Control Panel')},
{down = device_commands.Button_3,	up = device_commands.Button_3,	cockpit_device_id = devices.NPP_INSTRUCTOR,	value_down = 1,	value_up = 0,	name = _('RSBN-5 Course Accordance Button'),	category = _('RSBN-5 Control Panel')},
...
------------------------------------------------
{down = device_commands.Button_23,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,	name = _('Signal Flares Power Switch - ON/OFF'),	category = _('Signal Flares Control Panel')},
{down = device_commands.Button_23,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,		name = _('Signal Flares Power Switch - OFF'),		category = _('Signal Flares Control Panel')},
{down = device_commands.Button_23,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,		name = _('Signal Flares Power Switch - ON'),		category = _('Signal Flares Control Panel')},
{down = device_commands.Button_26,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,	name = _('White Signal Flare Button - ON/OFF'),		category = _('Signal Flares Control Panel')},
{down = device_commands.Button_26,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,		name = _('White Signal Flare Button - OFF'),		category = _('Signal Flares Control Panel')},
{down = device_commands.Button_26,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,		name = _('White Signal Flare Button - ON'),			category = _('Signal Flares Control Panel')},
{down = device_commands.Button_25,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,	name = _('Red Signal Flare Button - ON/OFF'),		category = _('Signal Flares Control Panel')},
{down = device_commands.Button_25,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,		name = _('Red Signal Flare Button - OFF'),			category = _('Signal Flares Control Panel')},
{down = device_commands.Button_25,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,		name = _('Red Signal Flare Button - ON'),			category = _('Signal Flares Control Panel')},
{down = device_commands.Button_24,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,	name = _('Green Signal Flare Button - ON/OFF'),		category = _('Signal Flares Control Panel')},
{down = device_commands.Button_24,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,		name = _('Green Signal Flare Button - OFF'),		category = _('Signal Flares Control Panel')},
{down = device_commands.Button_24,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,		name = _('Green Signal Flare Button - ON'),			category = _('Signal Flares Control Panel')},
{down = device_commands.Button_27,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,	name = _('Yellow Signal Flare Button - ON/OFF'),	category = _('Signal Flares Control Panel')},
{down = device_commands.Button_27,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,		name = _('Yellow Signal Flare Button - OFF'),		category = _('Signal Flares Control Panel')},
{down = device_commands.Button_27,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,		name = _('Yellow Signal Flare Button - ON'),		category = _('Signal Flares Control Panel')},


------------------------------------------------
-- Armament Control Panel -----------------
------------------------------------------------
{down = device_commands.Button_28,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,	name = _('ARMS Switch - ON/OFF'),	category = _('Armament Control Panel')},
{down = device_commands.Button_28,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,		name = _('ARMS Switch - OFF'),		category = _('Armament Control Panel')},
{down = device_commands.Button_28,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,		name = _('ARMS Switch - ON'),		category = _('Armament Control Panel')},
{down = device_commands.Button_29,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,	name = _('UB-16 Switch - ON/OFF'),	category = _('Armament Control Panel')},
{down = device_commands.Button_29,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,		name = _('UB-16 Switch - OFF'),		category = _('Armament Control Panel')},
{down = device_commands.Button_29,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,		name = _('UB-16 Switch - ON'),		category = _('Armament Control Panel')},
{down = device_commands.Button_30,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,	name = _('Gun Sight and Gun Camera Power Switch - ON/OFF'),	category = _('Armament Control Panel')},
{down = device_commands.Button_30,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,		name = _('Gun Sight and Gun Camera Power Switch - OFF'),	category = _('Armament Control Panel')},
{down = device_commands.Button_30,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,		name = _('Gun Sight and Gun Camera Power Switch - ON'),		category = _('Armament Control Panel')},
{down = device_commands.Button_31,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,	name = _('Missiles Heating Switch - ON/OFF'),	category = _('Armament Control Panel')},
{down = device_commands.Button_31,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,		name = _('Missiles Heating Switch - OFF'),		category = _('Armament Control Panel')},
{down = device_commands.Button_31,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,		name = _('Missiles Heating Switch - ON'),		category = _('Armament Control Panel')},
{down = device_commands.Button_32,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,	name = _('Missiles Glowing Switch - ON/OFF'),	category = _('Armament Control Panel')},
{down = device_commands.Button_32,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,		name = _('Missiles Glowing Switch - OFF'),		category = _('Armament Control Panel')},
{down = device_commands.Button_32,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,		name = _('Missiles Glowing Switch - ON'),		category = _('Armament Control Panel')},
...
{pressed = device_commands.Button_33,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_pressed = -0.5,	name = _('Missile Tone Volume Knob - CCW'),			category = _('Armament Control Panel')},
{pressed = device_commands.Button_33,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_pressed = 0.5,	name = _('Missile Tone Volume Knob - CW'),			category = _('Armament Control Panel')},
...
{down = device_commands.Button_35,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,	name = _('Live or Blank Switch Cover - OPEN/CLOSE'),	category = _('Armament Control Panel')},
{down = device_commands.Button_35,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,		name = _('Live or Blank Switch Cover - CLOSE'),			category = _('Armament Control Panel')},
{down = device_commands.Button_35,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,		name = _('Live or Blank Switch Cover - OPEN'),			category = _('Armament Control Panel')},
{down = device_commands.Button_36,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 1,		name = _('Live or Blank Switch - LIVE'),			category = _('Armament Control Panel')},
{down = device_commands.Button_36,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = -1,	name = _('Live or Blank Switch - BLANK'),			category = _('Armament Control Panel')},
{down = device_commands.Button_36,	cockpit_device_id = devices.WEAPON_SYSTEM,	value_down = 0,		name = _('Live or Blank Switch - NEUTRAL'),			category = _('Armament Control Panel')},
...
{action = device_commands.Button_19,	cockpit_device_id  = devices.CTRL_INTERFACE,	name = _('Front Cockpit Emergency Wheel Brake Lever')},
{action = device_commands.Button_20,	cockpit_device_id  = devices.CTRL_INTERFACE,	name = _('Second Cockpit Emergency Wheel Brake Lever')},
{action = device_commands.Button_7, cockpit_device_id  = devices.ASP_3NM, name = _('ASP-3NMU Gunsight Target Wingspan Adjustment Dial')},
{action = device_commands.Button_6, cockpit_device_id  = devices.ASP_3NM, name = _('ASP-3NMU Gunsight Target Distance')},
{action = device_commands.Button_18, cockpit_device_id  = devices.ASP_3NM, name = _('ASP-3 Glass Raise/Lower')},
})
