...
{down=device_commands.RUDStop_lock, up=device_commands.RUDStop_lock, cockpit_device_id=devices.ENGINE_START_DEVICE, value_down=1.0, value_up=0.0, name='Alt Throttle Lock Toggle', category='DCSToggleSwitches'},

--Alternate ASP mode
{down=device_commands.ASPpipperOn,			up=device_commands.ASPpipperOn,			cockpit_device_id=devices.ASP,	value_down=1.0,value_up=0.0,	name='Pipper Toggle switch',	category='DCSToggleSwitches'},
{down=device_commands.ASPnetOn,				up=device_commands.ASPnetOn,			cockpit_device_id=devices.ASP,	value_down=1.0,value_up=0.0,	name='Fix net Toggle switch',	category='DCSToggleSwitches'},
{down=device_commands.ASPmissileGunSelect,	up=device_commands.ASPmissileGunSelect,	cockpit_device_id=devices.ASP,	value_down=1.0,value_up=0.0,	name='Gun-missile Toggle',		category='DCSToggleSwitches'},

--Alternate ASP Mode - Giro
{down=device_commands.ASPssGiroSelect, up=device_commands.ASPssGiroSelect, cockpit_device_id=devices.ASP, value_down=1.0, value_up=0.0, name='Alternate ASP Mode - Giro', category='DCSToggleSwitches'},

--Alternate ASP Mode - Bombardment
{down=device_commands.ASPbombStrelbSelect, up=device_commands.ASPbombStrelbSelect, cockpit_device_id=devices.ASP, value_down=1.0, value_up=0.0, name='Alternate ASP Mode - Bombardment', category='DCSToggleSwitches'},

--Alternate ASP Main Mode
{down=device_commands.ASPmanAutoSelect, up=device_commands.ASPmanAutoSelect, cockpit_device_id=devices.ASP, value_down=1.0, value_up=0.0, name='Alternate ASP Main Mode', category='DCSToggleSwitches'},

--Alternate aileron booster
{down=device_commands.AileronBoosters, up=down=device_commands.AileronBoosters, cockpit_device_id=devices.MAIN_HYDRO,value_down=1.0, value_up=0.0, name='Alternate Aileron Boosters On/Off',category='DCSToggleSwitches'},
