...
{down = iCommandPlaneFlapsOff, up = iCommandPlaneFlaps, name = 'Flaps Up/Start', category = 'Alternative Controls'},
...
{down = iCommandPlaneFSQuantityIndicatorTest, up = iCommandPlaneFSQuantityIndicatorSelectorINT, name = _('Fuel Quantity Test'), category = _('Systems')},

-- Engines
{combos = {{key = "JOY_BTN30"}, }, down = iCommandLeftEngineStop, up = iCommandLeftEngineStart, name = _('Engine Left Start'), category = _('Systems')},
{combos = {{key = "JOY_BTN29"}, }, down = iCommandRightEngineStop, up = iCommandRightEngineStart, name = _('Engine Right Start'), category = _('Systems')},
...
{down = iCommandPlaneRadarOnOff, up = iCommandPlaneRadarOnOff,  name = _('Radar On/Off'), category = _('Sensors')},
